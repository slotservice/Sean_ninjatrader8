    ...
    public class TV_RenkoRangeStrategy : Strategy
    {
        ...
        protected override void OnStateChange()
        {
            ...
            else if (State == State.DataLoaded)
            {
                ...
                // These factory-method calls resolve to NT8-auto-generated methods on the
                // Strategy partial class (written to `@Strategy.cs` during compile).
                // If these produce CS1955 "Non-invocable member" errors on a specific NT8
                // install, the fix is `Tools → Remove NinjaScript Assembly`, then restart NT8
                // and compile again — this forces NT8 to regenerate @Strategy.cs cleanly.
